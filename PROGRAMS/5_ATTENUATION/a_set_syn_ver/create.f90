...
write(*,*)' Synthetic model in vertical sections'
write(*,*)' ar=',ar,' md=',md
...
do iver=1,nver
    ...
    do ips=1,2
        ...
        do ix=1,nxsec
            ...
            do iz=1,nzsec
                zcur=zmin+iz*dzsec
                dv=anomaly(xcur,ycur,zcur,ips+2)
       ...
       open(14,file='../../../TMP_files/att/syn_ver'//ps//ver//'.xyz')
       do ix=1,nxsec
            sss=(ix-1)*dxsec
            do iz=1,nzsec
                zcur=zmin+iz*dzsec
        ...
        open(14,file='../../../TMP_files/att/syn_ver'//ps//ver//'.grd')
        write(14,'(a4)')dsaa
...
! PLOT THE VELOCITY ANOMALIES
        ...
        51 format('..\..\..\PICS\',a8,'\',a8,'\SYN\vert_syn_att',a1,a2,'.png')
        ...
        write(14,52)ps,ver
        52 format('..\..\..\TMP_files\att\syn_ver',a1,a2,'.grd')
...
write(14,*)'_______ Key of the layer (1: contour, 2: line, 3:dots)'
write(14,552)ps,lv
552 format('..\..\..\TMP_files\att\syn_hor',a1,a2,'.grd')
write(14,*)'_______ Location of the GRD file'
